...
document.querySelector("#add").addEventListener("click", (e) => {
  e.preventDefault();
  let service_name = document.querySelector("#service_name").value;
  ...
  data.append("addRoomService", "sample");
...
document.querySelector("#deleteRoomBtn").addEventListener("click", (e) => {
  ...
  data.append("deleteRoomService", "sample");
  data.append("service_id", selectedRow.service_id);
...
document.querySelector("#setBooked").addEventListener("click", (e) => {
  ...
  data.append("changeServiceStatus", "sample");
  data.append("service_id", selectedRow.service_id);
  data.append("service_status", "Booked");
...
document.querySelector("#setAvailable").addEventListener("click", (e) => {
  ...
  data.append("changeServiceStatus", "sample");
  data.append("service_id", selectedRow.service_id);
  data.append("service_status", "Available");
...
document.addEventListener("DOMContentLoaded", () => {
  let data = new FormData();
  data.append("getAllRoomService", "sample");
  $.ajax({
    ...
    success: function (data) {
      ...
      const columnDefs = [
        { headerName: "ID", field: "service_id" },
