...
document.querySelector("#add").addEventListener("click", (e) => {
  ...
  let food_package = document.querySelector("#food_package").value;

  let data = new FormData();
  data.append("name", name);
  data.append("price", price);
  data.append("food_package", food_package);

  data.append("addFood", "sample");
...
document.querySelector("#deleteRoomBtn").addEventListener("click", (e) => {
  ...
  data.append("deleteFood", "sample");
  data.append("food_id", selectedRow.food_id);
...
document.querySelector("#setBooked").addEventListener("click", (e) => {
  ...
  data.append("changeFoodStatus", "sample");
  data.append("food_id", selectedRow.food_id);
  data.append("booking_status", "Not Available");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      const columnDefs = [
        { headerName: "ID", field: "food_id" },
        { headerName: "Name", field: "name" },
        { headerName: "Price", field: "price" },
        { headerName: "Food Package", field: "food_package" },
